...
pimcore.document.editables.date = Class.create(pimcore.document.editable, {
    ...
    initialize: function(id, name, config, data, inherited) {
        ...
        this.data = pimcore.helpers.date.parse(data);
    },
    ...
    getValue: function () {
        if(this.element) {
            return pimcore.helpers.date.format.dateOnly(this.element.getValue());
        } else if (this.data) {
            return pimcore.helpers.date.format.dateOnly(this.data);
        }
    },
